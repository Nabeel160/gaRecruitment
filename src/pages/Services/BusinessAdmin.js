      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mt-28 mb-8">
        <div className="w-full h-[500px] rounded-2xl overflow-hidden shadow-lg">
          <img
            ...
            alt="Business administration team"
        ...
        <div>
          ...
          <p className="text-lg text-gray-700 mb-6 leading-relaxed">
            Support your core operations with skilled administrative staff — from
            executive assistants to office managers — who keep your business
          ...
          <ul className="space-y-3 mb-8">
            <li className="flex items-start">
              ...
              <span className="text-gray-700 text-lg">Executive & personal assistants.</span>
            </li>
            <li className="flex items-start">
              <CheckCircle className="text-[#b57571] w-6 h-6 mr-3 mt-1" />
              <span className="text-gray-700 text-lg">Office managers & operations staff.</span>
            </li>
            <li className="flex items-start">
              <CheckCircle className="text-[#b57571] w-6 h-6 mr-3 mt-1" />
              <span className="text-gray-700 text-lg">Data entry and administrative coordinators.</span>
            </li>
            <li className="flex items-start">
              <CheckCircle className="text-[#b57571] w-6 h-6 mr-3 mt-1" />
              <span className="text-gray-700 text-lg">Reception & client-facing staff.</span>
            </li>
          </ul>
